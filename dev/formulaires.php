      ...
      <div class="modal-body">
		<div class="row">
			...
			<div class="<?php if(isset($_COOKIE['pseudo'])) echo 'col-md-8'; else echo 'col-md-12'; ?>">
				...
				<span class="center"><a href="#" data-target="#passRecover" data-toggle="modal">Mot de passe oublié ?</a></span>
			</div>
		</div>
      </div>
...
<div class="modal fade" id="InscriptionSlide" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		<span class="center"><div class="alert alert-warning" style="text-align: center;">Veuillez mettre une adresse email correcte !</div></span>
		<div class="form-group row">
		...
		<div class="form-group row">
			<label class="col-md-2 col-form-label" for="ageuser">Age</label>
			<div class="col-md-4">
				<input type="number" name="age" id="ageuser" class="form-control" value="0" min="0" max="9999">
			</div>
		</div>
		<div class="form-group row">
			<div class="col-md-6">
