<div class="heading">
        <h1 class="text-center wow fadeInDown"  data-wow-delay="2.1s" style="color:white;">Panier</h1>
</div>
    ...
    <br/>
        ...
        <form class="form-inline" action="?action=ajouterCode" method="POST">
            <div class="form-group">
                <input type="text" class="form-control" id="codepromo" name="codepromo" placeholder="Ex: PROMO8" style="border:0px;">
            </div>
            <button type="submit" class="btn btn-primary link" style="border:0px;">Valider</button>
        </form>
        <div class="text-right">
            <a href="?action=viderPanier">
            <button class="btn btn-lg btn-danger hvr-float-shadow">Supprimer les articles du panier</button></a>
            <a href="?action=achat"><button class="btn btn-lg btn-primary hvr-float-shadow">Valider l'achat</button></a>
        </div>
    </div>
</section>