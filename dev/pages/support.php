    <div class="heading">
        <h1 class="text-center wow fadeInDown"  data-wow-delay="2.1s" style="color:white;">Support</h1>
    </div>
<section class="layout" id="page">
<div class="container">
<br/>
	<div class="alert alert-primary alert-dismissable text-center">
		<button type="button" class="close" data-dismiss="alert">&times;</button>
		<h4><b><i class="fa fa-user-md"></i> Support communautaire</b></h4>
