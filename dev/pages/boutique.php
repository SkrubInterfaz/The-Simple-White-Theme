<div class="heading">
		<h1 class="text-center wow fadeInDown"  data-wow-delay="2.1s" style="color:white;">Boutique</h1>
</div>
...
<div class="container">
	...
	<div class="alert alert-primary alert-dismissable">
		...
		<?php if(isset($_Joueur_)) { ?>
			<font style="font-family: Verdana;font-size: 22px;">Bonjour <?php echo $_Joueur_['pseudo']; ?></font>
						...
						<div class="row">
								<?php
									...
									for($i = 1; $i <= count($offresTableau); $i++)
									{
										...
										{
											echo '
											<div class="col-md-4 card card-md4">
												<div class="card-body">
													<h3 class="card-title"><center>'. (($offresTableau[$i]['nbre_vente'] == 0) ? "<s>".$offresTableau[$i]['nom']."</s>" : $offresTableau[$i]['nom']);
