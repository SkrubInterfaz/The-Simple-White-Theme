...
?>
<div class="heading">
		<h1 class="text-center wow fadeInDown"  data-wow-delay="2.1s" style="color:white;">Profil (<?php echo htmlspecialchars($getprofil); ?>)</h1>
</div>
	...
	?>	
			<div class="categories-edit">
						<ul class="nav nav-tabs" id="modifProfil">
							...
							<li class="col-md-4"><a href="#autres" data-toggle="tab">Autres informations</a></li>
							<li class="col-md-4"><a href="#serveur" data-toggle="tab">Transfert de jetons</a></li>
						</ul>
					</div>
				<?php 
				...
				<div class="tab-content">
					...
					<div class="tab-pane" id="serveur">
						<h3 class="header-bloc header-form">Transfert de jetons</h3>
